...
# Set up storage path for downloaded data
output_path <- "~/Wageningen/University/Thesis/Data/elevation/geodata package"  # Adjust this to your preferred directory
dir.create(output_path, showWarnings = FALSE)

# Define bounding box for the contiguous USA
lon_range <- seq(-125, -67, by = 1)  # Longitude range (1-degree steps)
lat_range <- seq(24, 50, by = 1)     # Latitude range (1-degree steps)
